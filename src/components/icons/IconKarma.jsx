  ...
  return (
    <svg width={64} height={64} {...props}>
      <g fill="none">
        ...
        <path
          fill="#FDBF00"
          d="M25.372 24.727l2.651 2.651-3.979 3.979-2.651-2.651zm4.753 3.523h3.75v5.625h-3.75z"
        />
        <path
          fill="#FF9100"
          d="M38.628 24.727l3.979 3.979-2.651 2.651-3.979-3.979zm.872-5.852h5.625v3.75H39.5z"
        />
        <path
          fill="#FDBF00"
          d="M24.044 10.143l3.979 3.979-2.651 2.65-3.979-3.978zm-5.169 8.732H24.5v3.75h-5.625zm11.25-11.25h3.75v5.625h-3.75z"
        />
        <path
          d="M0 18.875h7.625v3.75H0zm6.585-4.065l-5.75-3.75 2.08-3.12 5.75 3.75zm-3.67 18.75l-2.08-3.12 5.75-3.75 2.08 3.12z"
          fill="#FFDA2D"
        />
        <path
          fill="#FDBF00"
          d="M56.375 18.875H64v3.75h-7.625zm4.71 14.685l-5.75-3.75 2.08-3.12 5.75 3.75zm-3.67-18.75l-2.08-3.12 5.75-3.75 2.08 3.12z"
        />
        <path
          fill="#FF9100"
